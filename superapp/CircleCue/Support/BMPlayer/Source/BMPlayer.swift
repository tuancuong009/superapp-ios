...
open class BMPlayer: UIView {
    ...
    open func updateInfoUI(newFeed: NewFeed?) {
        guard let feed = newFeed else { return }
        controlView.updateInfoViewUI(feed: feed)
    }
    ...
    open func play() {
        ...
        if BMPlayerConf.isEnablePanGesture {
...
//            UIApplication.shared.statusBarOrientation = .landscapeRight
    ...
    fileprivate func initUI() {
        ...
        panGesture.isEnabled = BMPlayerConf.isEnablePanGesture
    }
...
extension BMPlayer: BMPlayerControlViewDelegate {
    ...
    public func viewUserProfile() {
        delegate?.viewUserProfile()
    }
    
    public func didTapLikeAction() {
        delegate?.didTapLikeAction()
    }
    
    public func viewFeedCommentDetail() {
        delegate?.viewFeedComment()
        print(#function, self)
    }
    
    public func viewFeedLikedDetail() {
        delegate?.viewFeedLiked()
        print(self)
    }
