...
class NotificationTableViewCell2: UITableViewCell {
    ...
    func configCell(_ dict: NSDictionary){
        ...
        if let seen = dict.object(forKey: "seen") as? String, let intseen = Int(seen), intseen == 0{
            ...
            self.lblContent.font = UIFont(name: "Baloo2-Bold", size: 14)
            spaceRight.constant = 40
        }
        else{
            icRead.isHidden = true
            self.lblContent.font = UIFont(name: "Baloo2-Medium", size: 14)
