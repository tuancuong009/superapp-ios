...
import UIKit
import SDWebImage
class ResultSearchViewController: BaseMatcheronViewController {
    ...
    */
    ...
    private func callAPI(){
        ...
        APIHelper.shared.search_listing(userID) { success, dict in
            self.hideBusy()
            if let dict = dict{
                self.arrDatas = dict
            }
...
extension ResultSearchViewController: UIScrollViewDelegate{
